...
namespace Customer\Avtar\Ui\Component\Listing\Column;

use Magento\Framework\View\Element\UiComponentFactory;
use Magento\Framework\View\Element\UiComponent\ContextInterface;

class CustomerImage extends \Magento\Ui\Component\Listing\Columns\Column
{
    /**
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                $picture_url = !empty($customer["customer_pic"]) ? $this->urlBuilder->getUrl(
                    'customer/index/viewfile/image/'.base64_encode($customer["customer_pic"])) : $this->viewFileUrl->getUrl('Customer_Avtar::images/sk.jpg');
